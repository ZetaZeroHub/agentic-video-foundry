(function (root) {
  ...
  const nextFrameIndex = (current, count = FRAME_COUNT) => (current + 1) % count;

  const shouldAnimate = ({ visible, hidden, reducedMotion }) =>
  ...
  if (typeof module !== "undefined" && module.exports) {
    module.exports = { nextFrameIndex, shouldAnimate };
  } else {
    root.AgenticVideoMascot = { nextFrameIndex, shouldAnimate };
  }
